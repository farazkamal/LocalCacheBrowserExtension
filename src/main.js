...
function inject() {
    ...
    XMLHttpRequest = function () {
        ...
        let md5 = function () {
            ...
            function i(n, r) { n[r >> 5] |= 128 << r % 32, n[14 + (r + 64 >>> 9 << 4)] = r; var e, i, a, d, h, l = 1732584193, g = -271733879, v = -1732584194, m = 271733878; for (e = 0; e < n.length; e += 16)
            ...
            function d(n) { var t, r = []; for (r[(n.length >> 2) - 1] = void 0, t = 0; t < r.length; t += 1)
                r[t] = 0; var e = 8 * n.length; for (t = 0; t < e; t += 8)
                r[t >> 5] |= (255 & n.charCodeAt(t / 8)) << t % 32; return r; }
            function h(n) { return a(i(d(n), 8 * n.length)); }
            function l(n, t) { var r, e, o = d(n), u = [], c = []; for (u[15] = c[15] = void 0, o.length > 16 && (o = i(o, 8 * n.length)), r = 0; r < 16; r += 1)
                u[r] = 909522486 ^ o[r], c[r] = 1549556828 ^ o[r]; return e = i(u.concat(d(t)), 512 + 8 * t.length), a(i(c.concat(e), 640)); }
            function g(n) { var t, r, e = ""; for (r = 0; r < n.length; r += 1)
                t = n.charCodeAt(r), e += "0123456789abcdef".charAt(t >>> 4 & 15) + "0123456789abcdef".charAt(15 & t); return e; }
        ...
        self.open = function (method, url, async, user, password) {
            key.url = url;
            key.method = method || "GET";
            actual.open.apply(actual, arguments);
        };
        self.send = function (data) {
            key.data = data;
            actual.send.apply(actual, arguments);
        };
        actual.onreadystatechange = function () {
            if (self.onreadystatechange) {
                if (actual.readyState === 4) {
                    console.log(actual.getAllResponseHeaders());
                }
